...
const STORAGE_KEY = "sinlimiteia.flowEditor.view";
          ...
          <div className="flex items-center gap-4 px-6 py-3.5">
            ...
            <div className="ml-auto hidden flex-wrap items-center gap-x-3.5 gap-y-1.5 lg:flex">
              {LEGEND_TYPES.map((t_type) => (
                <span
                  key={t_type}
                  className="inline-flex items-center gap-1.5 text-[0.7188rem] text-muted-foreground"
                >
                  <span
...
function SegButton({
  ...
  return (
    <button
      ...
      aria-pressed={active}
      className={cn(
        "inline-flex items-center gap-1.5 rounded-md px-3 py-1.5 text-[0.7813rem] font-medium transition-colors",
        active
