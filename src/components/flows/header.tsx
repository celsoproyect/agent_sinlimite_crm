  ...
  return (
    <div className="flex flex-col gap-1.5 px-6 pt-5">
      <div className="flex flex-wrap items-center gap-3">
        ...
        {dirty && (
          <span
            className="inline-flex shrink-0 items-center gap-1.5 text-[0.625rem] font-medium uppercase tracking-wide text-amber-300"
        ...
        <div className="ml-auto flex flex-wrap items-center gap-1.5">
          ...
          >
            ...
            Runs
            <span className="ml-0.5 rounded bg-muted px-1.5 py-0.5 font-mono text-[0.6875rem] text-muted-foreground">
      ...
      <input
        ...
        className="w-full max-w-[78ch] rounded-md border border-transparent bg-transparent px-2 py-1 text-[0.8125rem] text-muted-foreground outline-none transition-colors placeholder:text-muted-foreground/60 hover:bg-muted/50 focus:border-primary focus:bg-transparent focus:text-foreground"
      />
    </div>
  );
}
...
function StatusChip({ status }: { status: BuilderState["status"] }) {
  ...
  return (
    <span
      className={cn(
        "inline-flex shrink-0 items-center gap-1.5 rounded-full border px-2.5 py-1 text-[0.7188rem] font-medium",
        cfg.cls,
      )}
    >
