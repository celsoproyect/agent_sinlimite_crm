                  ...
                  >
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        {status === 'revoked' && (
                          <Badge className="border-border bg-muted text-muted-foreground text-[0.625rem] tracking-wide uppercase">
                            {t('revoked')}
                          </Badge>
                        )}
                        {status === 'expired' && (
                      ...
                      <div className="mt-1.5 flex flex-wrap gap-1">
                        {k.scopes.length === 0 ? (
                          ...
                          k.scopes.map((s) => (
                            <Badge
                              key={s}
                              className="border-border bg-muted text-muted-foreground text-[0.625rem]"
                            >
                              {s}
                            </Badge>
                          ))
                ...
                <p className="text-muted-foreground text-xs">
                  {t.rich('scopesHint', {
                    code: (chunks: React.ReactNode) => (
                      <code className="text-[0.6875rem]">{chunks}</code>
                    ),
                  })}
                </p>
              </div>
